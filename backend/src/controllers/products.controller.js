...
const deleteProduct = async (req, res) => {
  ...
  const deleteProductService = await productsService.deleteProduct(productId);

  return res.status(mapStatusHTTP(deleteProductService.status))
    .json(deleteProductService.data);
};
